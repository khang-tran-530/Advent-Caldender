...
import yesImage from './images/usagi.gif';
    ...
    <div className="app">
      ...
      <main className="main-content">
        ...
        <div className="question-section">
          <h2 className="question">I hope you enjoy this present, and everytime you use it, you think of me &lt;3</h2>
          <p className="question-subtitle">I know you said dont buy you a present this year, but I couldnt help myself MWAHAHAH</p>
        </div>
