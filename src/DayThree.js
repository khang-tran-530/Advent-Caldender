...
import yesImage from './images/lick.gif';
    ...
    <div className="app">
      ...
      <main className="main-content">
        ...
        <div className="question-section">
          <h2 className="question">Knowing you, you must still be working on Tuesdays</h2>
          <p className="question-subtitle">After work, Let me know when you are ready, I will blind fold you and get things ready</p>
        </div>
