...
import yesImage from './images/cute-cat.gif';
    ...
    <div className="app">
      ...
      <main className="main-content">
        ...
        <div className="question-section">
          <h2 className="question">After your classes today, I will come pick you up and we'll go to a cafe for some dessert and drinks</h2>
          <p className="question-subtitle">Make sure you dress up so I can think some pictures of you!</p>
        </div>
