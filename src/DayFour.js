...
import yesImage from './images/cook.gif';
    ...
    <div className="app">
      ...
      <main className="main-content">
        ...
        <div className="question-section">
          <h2 className="question">Today, I'm making YOU a steak dinner. BE PREPARED MWAHAHAHAH. </h2>
          <p className="question-subtitle">this one is the only one im terrified of please please oh god please I pray it goes well</p>
        </div>
